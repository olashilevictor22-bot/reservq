							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									...
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('admin.create.product')}}" method="POST" enctype= "multipart/form-data" >
                                        @csrf
                                            <div class="row">
                                                <div class="col-lg-6 col-12">
                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="title" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Short Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" placeholder="Type here" type="text" name="short_description"></textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" placeholder="Type here" type="text" name="long_description"></textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" placeholder="Type here" type="text" name="seo_description"></textarea>
                                                ...
                                                <div class="col-lg-6 col-12">
                                                    <!-- Organization -->
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        <h4 class="form-title m-0">Management</h4>
                                                            <div class="form-group">
                                                                <label class="sherah-wc__form-label">Category*</label>
                                                                <select class="form-group__input" aria-label="Default select example" id="category" name="category_id">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-group__input" aria-label="Default select example" name="brand_id">
                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Regular Price</label>
                                                                    <div class="form-group__input">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="discount_price">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="sku">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Tags</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input" placeholder="Type here" type="text" name="tags"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="quantity">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" placeholder="Type here" type="text" name="weight">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Highlight</label>
                                                                    <div class="checkbox-group">

                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_hot" id="option15" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option15">Hot product</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_new" id="option16"  autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option16">New arrived</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_best" id="option17" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option17">Best product</label>
                                                                        </div>
                                                                        <div class="checkbox-group__single">
                                                                            <input type="checkbox" class="btn-check" value="1" name="is_featured" id="option18" autocomplete="off">
                                                                            <label class="checkbox-group__single--label" for="option18">Featured</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="image-upload-group">
                                                                ...
                                                                <div class="image-upload-group__single image-upload-group__single--upload">
                                                                    <input type="file" class="btn-check" name="thumbnail_image" id="input-img1" onchange="previewThumnailImage(event)" autocomplete="off"  >
                                                                    <label class="image-upload-label" for="input-img1">
                                                                        ...
                                                                        <input type="file" class="btn-check" name="thumbnail">
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#sub_category').change(function() {
            ...
            if(subcategory_id) {
                $.ajax({
                    url: '/childcategories/'+subcategory_id,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        $('#child_category').append('<option value="">Select Childcategory</option>');
                        $.each(data, function(key, value) {
