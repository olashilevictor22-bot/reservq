						...
						<div class="col-12">
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
                                    ...
                                    <form class="sherah-wc__form-main" action="{{route('languages.update',$language->id)}}" method="POST" enctype= "multipart/form-data" >
                                                @csrf
                                                @method('put')
                                            <div class="variant">
                                                    <div class="row">
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('city.status.update', ':Id') }}".replace(':Id',Id),
            dataType: "json",
