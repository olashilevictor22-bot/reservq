							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Cities</h2>
                                            ...
                                            <a href="{{route('cities.create')}}" class="sherah-btn sherah-gbcolor">Create City</a>
                                        </div>
                                    </div>
                                        ...
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-1 sherah-table__h1">State</th>
                                                    <th class="sherah-table__column-2 sherah-table__h2">City</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$city->state?->translate_state?->name}}</p>
														</div>
                                                    </td>

													<td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$city->translate_city?->name}}</p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
                                                            ...
                                                            <a href="{{route('cities.delete',$city['id'])}}" onclick="confirmation(event)" type="submit" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
									...
									<div class="row mg-top-40">
										{{$cities->links('Admin.component.pagination')}}
									</div>
								</div>
								<!-- End Dashboard Inner -->
							</div>
