							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Payment Method Images</h2>
                                                <ul class="sherah-breadcrumb__list">
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="">Payment Method Images</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('galleries.create')}}" class="sherah-btn sherah-gbcolor">Create New</a>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															...
															<a href="{{route('gallery.delete',$gallery['id'])}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
									...
									<div class="row mg-top-40">
										{{$galleries->links('Admin.component.pagination')}}
									</div>
								</div>
								<!-- End Dashboard Inner -->
							</div>
