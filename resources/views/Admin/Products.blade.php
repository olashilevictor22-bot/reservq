                            ...
                            <div class="sherah-dsinner">
                                	<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <a href="{{route('admin.upload.product')}}" class="sherah-btn sherah-gbcolor">Add Product</a>
                                    </div>
                                    ...
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <thead class="sherah-table__head">
                                            <tr>
                                                ...
                                                <th class="sherah-table__column-3 sherah-table__h3">Brand</th>
                                                <th class="sherah-table__column-7 sherah-table__h6">Stock</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$product->GetCategory?->name}}</p>
                                                    </div>
                                                </td>
                                                @else
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                ...
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{$product->GetBrand?->name}}</p>
                                                    </div>
                                                </td>
                                                @else
                                                <td class="sherah-table__column-4 sherah-table__data-4">
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeProductStatus({{ $product->id }})" type="checkbox" checked="">
                                                ...
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__status__group">
                                                        <a href="{{route('admin.edit.product',$product->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                        ...
                                                        <a href="{{url('/admin-product-image-gallery-index/'.$product['id'])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image" viewBox="0 0 16 16"> <path d="M6.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/> <path d="M2.002 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2h-12zm12 1a1 1 0 0 1 1 1v6.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12V3a1 1 0 0 1 1-1h12z"/>
                                                            </svg>
                                                        </a>
                                                        <a href="{{route('admin.destroy',$product['id'])}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
<script>
    ...
    function changeProductStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('product.status.chnage', ':productId') }}".replace(':productId',Id),
            dataType: "json",
