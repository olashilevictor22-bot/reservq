							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Edit Fontend Language</h2>
												<ul class="sherah-breadcrumb__list">
													<li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
													<li class="active"><a>Edit Fontend Language</a></li>
												</ul>
											</div>
										</div>
									</div>
                                                ...
                                                @foreach($languages as $index => $language)
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('fontend.language',[$language->lang_code])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                    ...
                                    <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('fontend.language.update',1)}}" method="POST" enctype= multipart/form-data >
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        <h4>Fontend Language</h4>
                                                        <div class="row">
                                                            @foreach($data as $index => $variable)
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                        <label class="sherah-wc__form-label">{{ $index }}</label>
                                                                        <div class="form-group__input">
                                                                            <input class="sherah-wc__form-input" type="text" name="values[{{ $index }}]" value="{{ $variable }}">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            @endforeach
