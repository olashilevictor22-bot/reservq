                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="sherah-breadcrumb mg-top-30">
                                            <h2 class="sherah-breadcrumb__title">Product Image Gallery</h2>
                                            <ul class="sherah-breadcrumb__list">
                                                <li><a href="#">Home</a></li>
                                                <li class="active"><a href="">Product Image Gallery</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                <form class="sherah-wc__form-main" action="{{route('admin.create.product.galerry.images')}}" method="POST" enctype= "multipart/form-data" >
                                    @csrf
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 m-5">
                                        <div class="form-group">
                                            <div class="form-group__input">
                                                <img src="{{asset($product['thumbnail_image'])}}" alt="" height="100" width="100" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 m-5">
                                        <div class="form-group">
                                        <label>Select images(You can select one or more images)</label>
                                            <div class="form-group__input">
                                                <input class="sherah-wc__form-input" type="file" name="images[]" multiple>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" mg-top-40 sherah-dflex sherah-dflex-gap-30 justify-content-end">
                                                <button type="submit" class="sherah-btn sherah-btn__primary">Add Gallery Image</button>
                                    </div>
                                </form>
                                </div>
                                <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                    <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                        ...
                                        <thead class="sherah-table__head">
                                            <tr>
                                                <th class="sherah-table__column-2 sherah-table__h2">SN</th>
                                        ...
                                        <tbody class="sherah-table__body">
                                            @php
                                                $i=1;
                                            @endphp
                                            @foreach($product_gallery as $index => $product_gallery)
                                            <tr>
                                                ...
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <img class="sherah-table__product-img" src="{{asset($product_gallery['image'])}}" alt="">
                                                    </div>
                                                </td>
                                                @if($product_gallery->status == 1)
                                                <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																  <input id="status" onclick="changeProductImageStatus({{ $product_gallery->id }})" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeProductImageStatus({{ $product_gallery->id }})" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
                                                ...
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__status__group">
                                                        <a href="{{url('/delete-image-from-image-gallery/'.$product_gallery['id'])}}" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
...
<script>
"use strict"
    function changeProductImageStatus(Id)
    {
        $.ajax({
            type:"GET",
            data: { _token : '{{ csrf_token() }}' },
            url: "{{ route('chnage.product.image.status', ':Id') }}".replace(':Id',Id),
            dataType: "json",
