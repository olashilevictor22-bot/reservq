							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Edit user Fontend Language</h2>
												<ul class="sherah-breadcrumb__list"> 
													<li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
													<li class="active"><a>Edit user Fontend Language</a></li>
												</ul>
											</div>
										</div>
									</div>
                                    ...
                                    <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                                ...
                                                @foreach($languages as $index => $language)
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('user.fontend.language',[$language->lang_code])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                        ...
                                        @if(!empty($translate_lang_massage))
                                    ...
                                    <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('user.fontend.language.update',$translate_lang_massage->id)}}" method="POST" enctype= multipart/form-data >
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <!-- Product Info -->
                                                    <div class="product-form-box sherah-border mg-top-30">
                                                        <h4>User Fontend Language</h4>
                                                        <div class="row">
                                                            @foreach($inputVariables as $variable)
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                        <label class="sherah-wc__form-label">{{ ucfirst(str_replace('_', ' ', $variable)) }}</label>
                                                                        <div class="form-group__input">
                                                                            <input class="sherah-wc__form-input" type="text" name="{{ $variable }}" value="{{ optional($translate_lang_massage)->{$variable} ?? '' }}">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            @endforeach
