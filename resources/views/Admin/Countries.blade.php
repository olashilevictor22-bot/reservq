							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Countries</h2>
                                                <ul class="sherah-breadcrumb__list">
                                                    <li><a href="{{route('admin.dashboard')}}">Home</a></li>
                                                    <li class="active"><a href="{{route('countries.index')}}">Countries</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('countries.create')}}" class="sherah-btn sherah-gbcolor">Create Countries</a>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$country->translate_country?->name}}</p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeStatus({{ $country->id }})" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeStatus({{ $country->id }})" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														...
														<a href="{{route('countries.edit',$country->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<a href="{{route('country.delete',$country->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
									...
									<div class="row mg-top-40">
										{{$countries->links('Admin.component.pagination')}}
									</div>
								</div>
								<!-- End Dashboard Inner -->
							</div>
...
<script>
    ...
    function changeStatus(Id)
        ...
        $.ajax({
            ...
            url: "{{ route('country-status', ':Id') }}".replace(':Id',Id),
            dataType: "json",
