									...
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Products Review</h2>
									...
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    <th class="sherah-table__column-6 sherah-table__h6">SN</th>
                                                    <th class="sherah-table__column-2 sherah-table__h2">User Name</th>
                                                    <th class="sherah-table__column-1 sherah-table__h1">Product Name</th>
                                                    <th class="sherah-table__column-3 sherah-table__h3">Review</th>
                                                    <th class="sherah-table__column-4 sherah-table__h4">Rating</th>
                                                    <th class="sherah-table__column-6 sherah-table__h6">Show</th>
                                                    <th class="sherah-table__column-5 sherah-table__h5">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody class="sherah-table__body">
												@foreach($product_review as $index => $review)
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{html_decode($review->user?->name)}}</p>
														</div>
                                                    </td>
                                                    ...
                                                    <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{html_decode($review->review)}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-table__product-content">
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																  <input id="status" onclick="changeReviewStatus({{ $review->id }})" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeReviewStatus({{ $review->id }})" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
													...
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<form action="{{route('ProductReview.destroy',$review['id'])}}" method="POST">
																@csrf
																@method('DELETE')
															<button type="submit" onclick="confirmation(event)"  class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
...
<script>
    ...
    function changeReviewStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('review.status.change', ':Id') }}".replace(':Id',Id),
            dataType: "json",
