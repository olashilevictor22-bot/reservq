									...
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Footer Social Link</h2>
                                                <ul class="sherah-breadcrumb__list">
                                                    <li><a href="#">Home</a></li>
                                                    <li class="active"><a href="">Footer Social Link</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('FooterSocialLink.create')}}" class="sherah-btn sherah-gbcolor">Add Link</a>
                                        </div>
                                    </div>
                                        ...
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-3 sherah-table__h3">Icon</th>
                                            ...
                                            <tbody class="sherah-table__body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$link['icon']}}</p>
														</div>
                                                    </td>
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('FooterSocialLink.edit',$link['id'])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
															...
															<form action="{{route('FooterSocialLink.destroy',$link->id)}}" method="POST">
																@csrf
																@method('DELETE')
																<button type="button" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
...
"use strict"
        ...
        function confirmation(ev) {
            ...
            var form = ev.currentTarget.parentElement; // Get the parent form element
            var urlToRedirect = form.getAttribute('action'); // Get the form's action attribute
