						...
						<div class="col-12">
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Testimonials</h2>
                                            ...
                                            <a href="{{route('testimonials.create')}}" class="sherah-btn sherah-gbcolor">Craete Testimonials</a>
                                        </div>
                                    </div>
                                        ...
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-3 sherah-table__h3">Designation</th>
                                            ...
                                            <tbody class="sherah-table__body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$testimonial->translate_testimonial?->name}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$testimonial->translate_testimonial?->designation}}</p>
														</div>
                                                    </td>
                                                  ...
                                                  <td class="sherah-table__column-6 sherah-table__data-6">
                                                      <div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                                          <label class="sherah__item-switch">
                                                                <input id="status" onclick="changeStatus({{ $testimonial->id }})" type="checkbox" checked="">
                                                ...
                                                <td class="sherah-table__column-6 sherah-table__data-6">
                                                      <div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                                          <label class="sherah__item-switch">
                                                              <input onclick="changeStatus({{ $testimonial->id }})" type="checkbox">
                                                              <span class="sherah__item-switch--slide sherah__item-switch--round"></span>
                                                          </label>
                                                      </div>
                                                  </td>
                                                @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('testimonials.edit',$testimonial['id'])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
																...
																<a href="{{route('testimonials.delete',$testimonial['id'])}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
									...
									{{$testimonials->links('Admin.component.pagination')}}
                                	</div>
								</div>
								<!-- End Dashboard Inner -->
							</div>
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('testimonial.status.update', ':Id') }}".replace(':Id',Id),
            dataType: "json",
