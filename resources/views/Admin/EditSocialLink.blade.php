						...
						<div class="col-12">
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
									<div class="row">
										<div class="col-12">
											<div class="sherah-breadcrumb mg-top-30">
												<h2 class="sherah-breadcrumb__title">Edit Social Link</h2>
                                    ...
                                    <form class="sherah-wc__form-main" action="{{route('FooterSocialLink.update',$social_link->id)}}" method="POST" enctype= "multipart/form-data" >
                                                @csrf
                                                @method('PUT')
                                            <div class="variant">
                                                    <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12" id="variant_name">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-group__input">
                                                                                <input class="sherah-wc__form-input" name="link" type="text" value="{{$social_link->link}}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12" id="item_name">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-group__input">
                                                                                <input class="sherah-wc__form-input" value="{{$social_link->icon}}"  type="text" name="icon" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
