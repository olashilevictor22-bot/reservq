                                            ...
                                            <tr>
                                                <td class="sherah-table__column-1 sherah-table__data-1">
                                                    <div class="sherah-table__product">
                                                        <h4 class="sherah-table__vendor--title"><a href="javascript:;">{{html_decode($customer['name'])}}</a></h4>
                                                    </div>
                                                </td>
                                                <td class="sherah-table__column-2 sherah-table__data-2">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{html_decode($customer['email'])}}</p>
                                                    </div>
                                                </td>
                                               @if($customer['phone'])
                                               <td class="sherah-table__column-4 sherah-table__data-4">
                                                    <div class="sherah-table__product-content">
                                                        <p class="sherah-table__product-desc">{{html_decode($customer['phone'])}}</p>
                                                    </div>
                                                </td>
                                                @else
                                                <td class="sherah-table__column-4 sherah-table__data-4">
                                                ...
                                                <td class="sherah-table__column-7 sherah-table__data-7">
                                                    <div class="sherah-table__status__group">
                                                        <a href="{{route('detils.customer',$customer->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
