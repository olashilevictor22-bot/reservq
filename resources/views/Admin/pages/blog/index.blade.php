								...
								<div class="sherah-dsinner">
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">Blogs</h2>
                                            ...
                                            <a href="{{route('blogs.create')}}" class="sherah-btn sherah-gbcolor">Create Blog</a>
                                        </div>
                                    </div>
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table id="sherah-table__vendor" class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    ...
                                                    <th class="sherah-table__column-4 sherah-table__h4" >Admin</th>
                                                    <th class="sherah-table__column-2 sherah-table__h2">Title</th>
                                                    <th class="sherah-table__column-6 sherah-table__h6">Image</th>
                                                    <!-- <th class="sherah-table__column-6 sherah-table__h6">Comments</th> -->
                                            ...
                                            <tbody class="sherah-table__body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$blog->admin->name}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$blog->blog_translate?->title}}</p>
														</div>
                                                    </td>
                                                  ...
                                                  <td class="sherah-table__column-6 sherah-table__data-6">
                                                      <div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                                          <label class="sherah__item-switch">
                                                                <input id="status" onclick="changeStatus({{ $blog->id }})" type="checkbox" checked="">
                                                ...
                                                <td class="sherah-table__column-6 sherah-table__data-6">
                                                      <div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
                                                          <label class="sherah__item-switch">
                                                              <input onclick="changeStatus({{ $blog->id }})" type="checkbox">
                                                              <span class="sherah__item-switch--slide sherah__item-switch--round"></span>
                                                          </label>
                                                      </div>
                                                  </td>
                                                @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															...
															<a href="{{route('blog-delete',$blog->id)}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset blog_comment_delete">
										...
										<div class="row mg-top-40">
											{{ $blogs->links('Admin.component.pagination') }}
										</div>
									</div>
								</div>
								<!-- End Dashboard Inner -->
...
<script>
    ...
    function changeStatus(Id)
    {
        $.ajax({
            ...
            url: "{{ route('blog.status.change', ':Id') }}".replace(':Id',Id),
            dataType: "json",
