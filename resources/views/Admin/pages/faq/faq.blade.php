									...
									<div class="row mg-top-30">
                                        <div class="col-12 sherah-flex-between">
                                            ...
                                            <div class="sherah-breadcrumb">
                                                <h2 class="sherah-breadcrumb__title">FAQs</h2>
                                                <ul class="sherah-breadcrumb__list">
                                                    <li><a href="#">Home</a></li>
                                                    <li class="active"><a href="{{route('faqs.index')}}">FAQs</a></li>
                                                </ul>
                                            </div>
                                            <!-- End Sherah Breadcrumb -->
                                            <a href="{{route('faqs.create')}}" class="sherah-btn sherah-gbcolor">Create faqs</a>
                                        </div>
                                    </div>
									...
									<div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                        <table class="sherah-table__main sherah-table__main-v3">
                                            ...
                                            <thead class="sherah-table__head">
                                                <tr>
                                                    <th width="5%"  class="sherah-table__column-1 sherah-table__h1">SN</th>
                                                    <th width="20%" class="sherah-table__column-2 sherah-table__h2">Questions</th>
                                                    <th width="45%" class="sherah-table__column-3 sherah-table__h3">Answer</th>
                                                    <th width="10%" class="sherah-table__column-6 sherah-table__h6">Status</th>
                                                    <th width="20%" class="sherah-table__column-5 sherah-table__h5">Action</th>
                                                </tr>
                                            </thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="sherah-table__column-2 sherah-table__data-2">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">{{$faq->translate_faq?->question}}</p>
														</div>
                                                    </td>
                                                    <td class="sherah-table__column-5 sherah-table__data-5">
														<div class="sherah-table__product-content">
															<p class="sherah-table__product-desc">
                                                            {!! $faq->translate_faq?->answer !!}</p>
														</div>
                                                    </td>
													...
													<td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																  <input id="status" onclick="changeStatus({{ $faq->id }})" type="checkbox" checked="">
												  ...
												  <td class="sherah-table__column-6 sherah-table__data-6">
														<div class="sherah-ptabs__notify-switch sherah-ptabs__notify-switch--two">
															<label class="sherah__item-switch">
																<input onclick="changeStatus({{ $faq->id }})" type="checkbox">
																<span class="sherah__item-switch--slide sherah__item-switch--round"></span>
															</label>
														</div>
													</td>
												  @endif
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															...
															<a href="{{route('faq.delete',$faq['id'])}}" onclick="confirmation(event)" class="sherah-table__action sherah-color2 sherah-color2__bg--offset">
										...
										<div class="row mg-top-40">
											{{ $faqs->links('Admin.component.pagination') }}
										</div>
									</div>
...
<script>
    ...
    $.ajax({
        ...
        url: "{{ route('faq.status.change', ':Id') }}".replace(':Id',Id),
        dataType: "json",
