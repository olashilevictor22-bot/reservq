							...
							<div class="sherah-body">
								...
								<div class="sherah-dsinner">
                                            ...
                                            <tbody class="sherah-table__body">
                                                <tr>
                                                    <td><div class="sherah-table__status__group">
															<a href="{{route('product.edit',$products->id)}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
                                                ...
                                                @foreach($languages as $index => $language)
													<td class="sherah-table__column-8 sherah-table__data-8">
														<div class="sherah-table__status__group">
															<a href="{{route('product.item.language.edit',[$products->id,$language->lang_code])}}" class="sherah-table__action sherah-color2 sherah-color3__bg--opactity">
																<svg class="sherah-color3__fill" xmlns="http://www.w3.org/2000/svg" width="18.29" height="18.252" viewBox="0 0 18.29 18.252">
																	<g id="Group_132" data-name="Group 132" transform="translate(-234.958 -37.876)">
																		<path id="Path_481" data-name="Path 481" d="M242.545,95.779h-5.319a2.219,2.219,0,0,1-2.262-2.252c-.009-1.809,0-3.617,0-5.426q0-2.552,0-5.1a2.3,2.3,0,0,1,2.419-2.419q2.909,0,5.818,0c.531,0,.87.274.9.715a.741.741,0,0,1-.693.8c-.3.026-.594.014-.892.014q-2.534,0-5.069,0c-.7,0-.964.266-.964.976q0,5.122,0,10.245c0,.687.266.955.946.955q5.158,0,10.316,0c.665,0,.926-.265.926-.934q0-2.909,0-5.818a.765.765,0,0,1,.791-.853.744.744,0,0,1,.724.808c.007,1.023,0,2.047,0,3.07s.012,2.023-.006,3.034A2.235,2.235,0,0,1,248.5,95.73a1.83,1.83,0,0,1-.458.048Q245.293,95.782,242.545,95.779Z" transform="translate(0 -39.652)" fill="#09ad95"/>
																		<path id="Path_482" data-name="Path 482" d="M332.715,72.644l2.678,2.677c-.05.054-.119.133-.194.207q-2.814,2.815-5.634,5.625a1.113,1.113,0,0,1-.512.284c-.788.177-1.582.331-2.376.48-.5.093-.664-.092-.564-.589.157-.781.306-1.563.473-2.341a.911.911,0,0,1,.209-.437q2.918-2.938,5.853-5.86A.334.334,0,0,1,332.715,72.644Z" transform="translate(-84.622 -32.286)" fill="#09ad95"/>
                                    ...
                                    <div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('product.item.language.update',$translate_product->id)}}" method="POST" enctype= multipart/form-data >
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <!-- Product Info -->
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" value="{{ $translate_product->name }}" placeholder="Type here" type="text" id="name" name="name" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="vedio_top_ber_description" row="8" placeholder="type here" type="text" name="vedio_top_ber_description">{{ $translate_product->vedio_top_ber_description }}</textarea>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="vedio_buttom_description" row="8" placeholder="type here" type="text" name="vedio_buttom_description">{{ $translate_product->vedio_buttom_description }}</textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="description" row="8" placeholder="Type here" type="text" name="long_description">{{$translate_product->long_description}}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <table class="table table-bordered table-hover" id="dynamic_field">
                                                                            ...
                                                                            @foreach(json_decode($translate_product->size, true) as $size => $price)
                                                                                <tr>
                                                                                    <td>
                                                                                        <input type="text" name="size[]" placeholder="Enter Size" class="form-control name_list" value="{{ $size }}" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="number" name="price[]" placeholder="Enter Price" class="form-control name_email" value="{{ $price }}" />
                                                                                    </td>
                                                                                    @if ($loop->first)
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <table class="table table-bordered table-hover" id="dynamic_field2">
                                                                            @foreach(json_decode($translate_product->specifaction, true) as $name)
                                                                                <tr>
                                                                                <td>
                                                                                    <input type="text" name="specifaction[]" value="{{$name}}" placeholder="Enter Single Item" class="form-control name_list1" />
                                                                                </td>
                                                                                @if ($loop->first)
                                    ...
                                    @else
									<div class="sherah-page-inner sherah-border sherah-basic-page sherah-default-bg mg-top-25 p-0">
                                        <form class="sherah-wc__form-main" action="{{route('product.item.update',$products->id)}}" method="POST" enctype= multipart/form-data >
                                        @csrf
                                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Name</label>
                                                                    <div class="form-group__input">
                                                                        <input class="sherah-wc__form-input" value="{{ $products->translate_product->name }}" placeholder="Type here" type="text" id="name" name="name" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group__input">
                                                                    <input class="sherah-wc__form-input" value="{{ $products->slug }}" placeholder="Type here" type="text" name="slug" id="slug" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-group__input" aria-label="Default select example" name="category_id">
                                                                        ...
                                                                        @foreach($categories as $categorie)
                                                                            <option {{$categorie->id == $products->category_id ? 'selected' : ' '}} value ="{{$categorie->id}}">{{$categorie->translate_category?->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="sherah-wc__form-input" value="{{$products->price }}" required placeholder="Type here" type="number" name="main_price" id="price">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Offer Price *</label>
                                                                    <input class="sherah-wc__form-input" value="{{$products->offer_price }}" placeholder="Type here" type="number" name="offer_price" id="offer_price">
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Video Url *</label>
                                                                    <input class="sherah-wc__form-input" value="{{$products->vedio_url }}" placeholder="Type here" type="text" name="vedio_url" id="vedio_url">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Video Top Ber Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="vedio_top_ber_description" row="8" placeholder="type here" type="text" name="vedio_top_ber_description">{{ $products->translate_product->vedio_top_ber_description }}</textarea>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Video Bottom Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="vedio_buttom_description" row="8" placeholder="type here" type="text" name="vedio_buttom_description">{{ $products->translate_product->vedio_buttom_description }}</textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Long Description</label>
                                                                    <div class="form-group__input">
                                                                        <textarea class="sherah-wc__form-input summernote" id="description" row="8" placeholder="Type here" type="text" name="long_description">{{$products->translate_product->long_description}}</textarea>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="sherah-wc__form-input" value="{{$products->seo_titel }}" placeholder="Type here" type="text" name="seo_titel" id="seo_titel">
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="sherah-wc__form-label">Seo Description *</label>
                                                                    <textarea class="sherah-wc__form-input" id="description" row="8" placeholder="type here" type="text" name="seo_description">{{$products->seo_description}}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-group__input" aria-label="Default select example" name="is_populer">
                                                                        <option {{$products->is_populer == '1' ? 'selected' :''}} value ="1">Yes</option>
                                                                        <option {{$products->is_populer == '0' ? 'selected' :''}} value="0">No</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        @foreach($items as $item)
                                                                            <div class="checkbox-group__single">
                                                                                <input {{ in_array($item->id, $selectedIds) ? 'checked' : '' }} type="checkbox" value="{{$item->id}}" class="btn-check" name="items[]" id="option{{$item->id}}" autocomplete="off" required>
                                                                                <label class="checkbox-group__single--label" for="option{{$item->id}}">{{$item->translate_item->name}}</label>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            <div class="image-upload-group__single">
                                                                                <img class="product_thumb_img" id="preview-img" src="{{asset($products->tumb_image)}}">
                                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="product-form-box sherah-border mg-top-30">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="image-upload-group">
                                                                            <div class="image-upload-group__single">
                                                                                <img class="product_thumb_img" id="preview-img1" src="{{asset($products->vedio_tumb_image)}}">
                                                                            </div>
                                                                            <div class="image-upload-group__single image-upload-group__single--upload">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <table class="table table-bordered table-hover" id="dynamic_field">
                                                                            @foreach(json_decode($products->translate_product->size, true) as  $size => $price)
                                                                            <tr class='row_table'>
                                                                                <td>
                                                                                    <input type="text" name="size[]" placeholder="Enter Size" class="form-control name_list" value="{{ $size }}" />
                                                                                </td>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox-group">
                                                                        <table class="table table-bordered table-hover" id="dynamic_field2">
                                                                            @foreach(json_decode($products->translate_product->specifaction, true) as $name)
                                                                                <tr class='row_table1'>
                                                                                <td>
                                                                                    <input type="text" name="specifaction[]" value="{{$name}}" placeholder="Enter Single Item" class="form-control name_list1" />
                                                                                </td>
