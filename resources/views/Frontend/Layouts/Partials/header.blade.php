                        ...
                        <div class="nav-main">
                            ...
                            <div class="nav-btn-main">
                                <form action="{{route('menu')}}" method="GET" >
                                    <div class="nav-btn-one">
                                        <input type="text" name="keyword" class="form-control" id="exampleFormControlInput1" placeholder="{{ __('translate.Search here') }}">
                                    ...
                                    <div class="love cart">
                                        ...
                                        <div class="cart-dropdown header-dropdown" id="cart-dropdown">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="{{route('menu')}}" class="main-btn-four">{{ __('translate.Shop Now') }}</a>
                                            </div>
                                            @endif
                            ...
                            @if(!Auth::user())
                                <div class="nav-login-btn-main">
                                    <a  href="{{route('login')}}" class="main-btn-four">{{ __('translate.Sign In') }}</a>
